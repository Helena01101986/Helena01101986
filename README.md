...
*Используемые сценарии:* Набор чек-листов для проверки функционала веб-станицы, заведение баг-репортов, тестирование верстки страницы с помощью PerfectPixel.
</details>
